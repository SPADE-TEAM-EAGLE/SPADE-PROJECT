...
exports.insertInvoice = 'INSERT INTO invoice (landlordID, tenantID, invoiceType, startDate, endDate, frequency, dueDate,daysDue, repeatTerms, terms,note,status,created_at,totalAmount, recurringNextDate,notify) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
...
exports.addTasksQuery = "INSERT INTO task (taskName, tenantID, dueDate,status, priority, notes, notifyTenant, notifyVendor, created_at , createdBy,landlordID,notify) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
