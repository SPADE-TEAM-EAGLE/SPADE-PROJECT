...
exports.insertInUserPermissionUsers =
  ...
  exports.updateUserAdminQuery = "UPDATE superAdmin SET fName = ?, lName = ?, email = ?, phone = ?, password = ?, role = ?, address = ?, city = ?, state = ?, zipcode = ?, images = ? , imageKey = ?, updated_at = ? WHERE id = ?"; 
