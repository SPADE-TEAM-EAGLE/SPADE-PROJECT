...
<head>
  ...
  <div style="text-align: center;">
    <table align="center" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; text-align: center; vertical-align: top; width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 20px 20px 0 0 ;">
      <tbody>
        <tr>
  ...
  <td>
    ...
    <!-- <table align="center" style="box-shadow:rgba(0, 0, 0, 0.1) 0px 4px 12px; text-align: center; vertical-align: top; width: 900px; max-width: 900px; background-color: #ffffff; border-radius: 0 0 20px 20px;" width="600">
        <tbody>
          <tr> -->
            <table align="center" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; text-align: center; vertical-align: top; width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 0 0 20px 20px;">
              <tbody>
                  <tr>
