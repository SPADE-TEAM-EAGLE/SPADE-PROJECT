exports.paymentHTML = (Name,subscriptionDate,Amount,planName) => {
        ...
        <head>
          ...
          <div style="text-align: center;">
            ...
            <table align="right"  style=" text-align: center; vertical-align: middle; width: 900px; max-width: 900px;" width="600">
              <tbody>
                <tr>
            ...
            <table align="center" style=" border-radius: 20px 20px 0 0; box-shadow:rgba(0, 0, 0, 0.1) 0px 4px 12px;   text-align: center; vertical-align: top; width: 900px; max-width: 900px; background-color: #ffffff; " width="600">
              <tbody>
                <tr>
