exports.tenantWelcomeHTML0 = (email, password, name) => {
  ...
  exports.tenantWelcomeHTML1 = (email, password, name) => {
    ...
    <tr>
      <td><img src="https://spades3bucket.s3.amazonaws.com/1693914258761_1693913789165_buliding-email%20%284%29.png" alt="" style="height: 150px; width: 100%; margin-bottom: 20px; border-radius: 25px;"></td>
    </tr>
      <tr class=""><td class="headline">Welcome <b>${name}</b> to Spade Rent!</td></tr>
      <tr>
      <td>
